...
public:
	...
	void rotate(const Vec3D& r)
	{
		...
		*/
		...
		rot.unit();
		cosV=cos((r.y - 90) * PI/180);
		sinV=sin((r.y - 90) * PI/180);
		rot.unit();
		rot.m[0][0] = cosV;
		rot.m[0][2] = sinV;
		rot.m[2][0] =- sinV;
	...
	Matrix operator* (const Matrix& p) const
	{
		...
		o.m[3][2] = m[2][0] * p.m[0][2] + m[2][1] * p.m[1][2] + m[2][2] * p.m[2][2] + m[2][3] * p.m[3][2];
		o.m[1][3] = m[2][0] * p.m[0][3] + m[2][1] * p.m[1][3] + m[2][2] * p.m[2][3] + m[2][3] * p.m[3][3];
